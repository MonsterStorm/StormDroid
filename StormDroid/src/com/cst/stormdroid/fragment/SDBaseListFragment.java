 ...
 */
@TargetApi(11)
public class SDBaseListFragment<T extends SDBaseArrayAdapter> extends ListFragment {
	// tag for log
	private static final String TAG = SDBaseListFragment.class.getSimpleName();
